...
function HistoriaBiew({ historia }) {
  ...
  const handlerDelete = async (id_historia_barrio) => {
    try {
      await axios.delete("/api/parroquia/barrio/historia/" + id_historia_barrio)
      ...
      <div className="bg-white w-full  p-10">
        ...
        <div className="flex items-center justify-center">
          ...
          <button
            ...
            onClick={() =>
              router.push(
                "/dashboard/parroquia/barrio/historia/edit/" +
...
export const getServerSideProps = async (context) => {
  const { data: historia } = await axios.get(
    "http://localhost:3000/api/parroquia/barrio/historia/" + context.query.id
  )
